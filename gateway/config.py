        ...
        if config_yaml_path.exists():
            ...
            for plat in _shared_loop_targets:
                ...
                if plat == Platform.TELEGRAM:
                    telegram_extra = platform_cfg.get("extra")
                    if isinstance(telegram_extra, dict) and "topic_response_rules" in telegram_extra:
                        bridged["topic_response_rules"] = telegram_extra["topic_response_rules"]
